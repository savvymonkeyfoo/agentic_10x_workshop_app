            ...
            <div className="group relative block bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all border border-slate-100 dark:border-slate-700 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 z-10 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                    <button
                        ...
                        className="p-2 bg-white dark:bg-slate-700 rounded-lg shadow-sm hover:text-brand-blue text-slate-400 dark:text-slate-400 transition-colors"
                        title="Edit"
                    >
                    ...
                    <button
                        ...
                        className="p-2 bg-white dark:bg-slate-700 rounded-lg shadow-sm hover:text-status-risk text-slate-400 dark:text-slate-400 transition-colors"
                        title="Delete"
                    >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="relative pointer-events-none"> {/* Content wrapper */}
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex-1 flex gap-3 items-center">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-brand-navy dark:text-white group-hover:text-brand-blue transition-colors leading-tight">
                                    {workshop.clientName}
                                </h2>
                    ...
                    <div className="flex items-center gap-2 text-slate-500 text-sm mt-4 pl-1">
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
